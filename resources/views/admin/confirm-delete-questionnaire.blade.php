...
<div class="max-w-lg mx-auto mt-8">
    <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="mt-6 flex justify-end space-x-3">
            <a href="{{ route('admin.all-questionnaire', ['categoryId' => $questionnaire->category_id]) }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-400 transition duration-200">Cancel</a>
            <form action="{{ route('admin.delete-questionnaire', $questionnaire->id) }}" method="POST">
                @csrf
                @method('DELETE')
