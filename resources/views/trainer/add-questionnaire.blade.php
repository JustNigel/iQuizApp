...
<div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
    <a href="{{ route('trainer.all-category') }}" class="text-indigo-600 hover:text-indigo-700 font-medium mb-6 inline-block">&larr; Back</a>

    <h1 class="text-3xl font-semibold mb-6 text-center">Create Questionnaire</h1>

    <form action="{{ route('trainer.store-questionnaire') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="flex items-center">
                    ...
                    <select id="trainer" name="trainer_id" class="block w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2" disabled>
