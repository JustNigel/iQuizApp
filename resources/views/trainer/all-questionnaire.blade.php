...
<div class="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-lg">
    <a href="{{ route('trainer.all-category') }}" class="text-indigo-600 hover:text-indigo-700 font-medium mb-6 inline-block">&larr; Return to All Categories</a>
        ...
        <table class="min-w-full divide-y divide-gray-200"> 
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 text-center whitespace-nowrap">
                        <a href="#" class="bg-blue-500 px-3 py-1 mr-2 rounded-md text-white hover:bg-blue-600 transition duration-150 ease-in-out">
                            <i class="fas fa-pencil-alt"></i>
                        </a>
                        <a href="#" class="bg-red-500 px-3 py-1 rounded-md text-white hover:bg-red-600 transition duration-150 ease-in-out">
