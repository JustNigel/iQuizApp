                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-center whitespace-nowrap text-sm font-medium">
                                <div class="flex justify-center space-x-3">
                                    <a title="Edit Questionnaire" href="{{route('trainer.edit-questionnaire', [$questionnaire->id, 'from' => 'all-questionnaires'])}}" class="bg-blue-500 px-3 py-1 rounded-md text-white hover:bg-blue-600 transition duration-150 ease-in-out">
