...
<div class="container mx-auto p-6">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-softwhite p-4 rounded-lg shadow-md">
            ...
            <div class="flex items-center justify-between bg-gray-200 p-4 rounded-lg mb-2 hover:bg-gray-300 transition duration-300 ease-in-out">
                <a href="{{route('trainer.all-confirmed-students', ['from' => 'dashboard'])}}" class="flex-grow block text-black"> 
                    <i class="fa-solid fa-user-group mr-1"></i> 
                    All Students Exam
                </a>
                <div class="relative">
                
                    <a href="{{route('trainer.all-exam-request')}}" class="p-2 bg-gray-300 rounded hover:bg-gray-400 transition duration-300 ease-in-out">
        ...
        <div class="bg-softwhite p-4 rounded-lg shadow-md">
            ...
            <div class="flex items-center justify-between bg-gray-200 p-4 rounded-lg mb-2 hover:bg-gray-300 transition duration-300 ease-in-out">
                <a href="{{route('trainer.all-students', ['from' => 'dashboard'])}}" class="flex-grow block text-black"> 
                    <i class="fa-solid fa-user-group mr-1"></i> 
                    All Students
                </a>
                <div class="relative">
                    <a href="{{route('trainer.all-registration-request', ['from' => 'dashboard'])}}" class="p-2 bg-gray-300 rounded hover:bg-gray-400 transition duration-300 ease-in-out">
                        <i class="fa-solid fa-bell text-custombg-gray text-lg"></i>
                    </a>
