...
<div class="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-lg">
    <div class="flex justify-between mb-2">
        ...
        @if ($previousPage === 'all-students')
            <a href="{{route('trainer.dashboard')}}" class="text-indigo-600 hover:text-indigo-700 font-medium inline-block">&larr; Return to All Students</a>
        @else   
        ...
        @endif
            <a href="{{ route('trainer.all-registration-request', ['from' => 'all-students']) }}" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-200">
