                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center whitespace-nowrap text-sm font-medium">
                            <div class="flex justify-center space-x-3">
                                <a href="{{ route('trainer.acceptRequest', $request->id)}}" class="bg-green-500 px-3 py-1 rounded-md text-white hover:bg-green-600 transition duration-150 ease-in-out"><i class="fa-solid fa-check"></i></a>
                                <a href="{{ route('trainer.denyRequest', $request->id)}}" class="bg-red-500 px-3 py-1 rounded-md text-white hover:bg-red-600 transition duration-150 ease-in-out"><i class="fa-solid fa-x"></i></a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
