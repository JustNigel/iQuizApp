<div class="bg-custombg-gray shadow p-4 flex items-center font-satoshi">
    <a href="{{route('admin.dashboard.dashboard')}}" class="flex items-center space-x-2 mr-4">
    ...
    <div class="flex-1 flex justify-center">
        <h2 class="text-lg text-gray-100 font-semibold"></h2>
    </div>
    <a href="{{ route('profile') }}">
        <div class="flex items-center space-x-4 mr-4">
            <span class="hidden text-right lg:block">
                <span class="block text-sm font-medium text-gray-200 dark:text-gray-100">{{ $user->name }}</span>
